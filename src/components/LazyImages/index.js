...
var _event = require("./LazyUtils/event");

var _scrollParent = require("./LazyUtils/scrollParent");

var _scrollParent2 = _interopRequireDefault(_scrollParent);

var _debounce = require("./LazyUtils/debounce");

var _debounce2 = _interopRequireDefault(_debounce);

var _throttle = require("./LazyUtils/throttle");
      ...
      value: function componentDidMount() {
        if (
          ...
          if (
            ...
            _reactDom2.default.findDOMNode(this).offsetHeight === 0
          ) {
            console.warn(
        ...
        if (!finalLazyLoadHandler) {
          if (this.props.debounce !== undefined) {
            finalLazyLoadHandler = (0, _debounce2.default)(
              lazyLoadHandler,
            ...
            finalLazyLoadHandler = (0, _throttle2.default)(
              lazyLoadHandler,
...
LazyLoad.propTypes = {
  ...
  throttle: _propTypes2.default.oneOfType([
    _propTypes2.default.number,
    _propTypes2.default.bool,
  ]),
  debounce: _propTypes2.default.oneOfType([
    _propTypes2.default.number,
    _propTypes2.default.bool,
  ]),
